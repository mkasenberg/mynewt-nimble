...
/* DPPIC00 [0:7] */
#define DPPI_CH_DPPIC00_TIMER00_EVENTS_COMPARE_0  0
#define DPPI_CH_DPPIC00_TIMER00_EVENTS_COMPARE_3  1
#define DPPI_CH_DPPIC00_RADIO_EVENTS_ADDRESS      2
#define DPPI_CH_DPPIC00_RADIO_EVENTS_END          3
#define DPPI_CH_DPPIC00_RADIO_EVENTS_PHYEND       4
#define DPPI_CH_DPPIC00_RTC0_EVENTS_COMPARE_0     5
...
phy_ppi_rtc0_compare0_to_timer0_start_enable(void)
{
    ...
    NRF_TIMER10->SUBSCRIBE_START = DPPI_CH_SUB(RTC0_EVENTS_COMPARE_0);
}
...
phy_ppi_rtc0_compare0_to_timer0_start_disable(void)
{
    ...
    NRF_TIMER10->SUBSCRIBE_START = DPPI_CH_UNSUB(RTC0_EVENTS_COMPARE_0);
    NRF_TIMER10->SUBSCRIBE_CAPTURE[3] = DPPI_CH_UNSUB(RADIO_EVENTS_ADDRESS);
...
{
    NRF_TIMER10->SUBSCRIBE_CAPTURE[3] = DPPI_CH_SUB(RADIO_EVENTS_ADDRESS);
...
static inline void
phy_ppi_wfr_to_radio_stop_enable(void)
{
