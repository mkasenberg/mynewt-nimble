...
void ble_ll_cs_sync_results_set(struct ble_ll_cs_step *step, struct ble_phy_cs_sync_results *results);
void ble_ll_cs_tone_results_set(struct ble_ll_cs_step *step, struct ble_phy_cs_tone_results *results);
#ifdef __cplusplus
}
#endif
